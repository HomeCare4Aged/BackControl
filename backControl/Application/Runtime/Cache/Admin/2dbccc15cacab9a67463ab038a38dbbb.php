...
<nav class="navbar navbar-default navbar-fixed-top">
	...
	<div id="page-wrapper">
		<div class="container-fluid">
				...
				<div class="col-md-12">
					<ol class="breadcrumb">
						<li>
							...
							<a href="/home1/admin.php/Video/index">视频浏览</a>
						</li>
						<li class="active">
			...
			<!--表单.row-->
			<div class="row">
				<video id="myVideo" width="700" height="300" controls style="position: absolute;margin-left: 15px;">
		        ...
		        <div class="col-sm-4 col-sm-offset-8">
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<label class="control-label" <?php if($menu['video_check_state'] == 未审核): ?>style="display:none ;"<?php endif; ?>><?php echo ($menu["hospital_user_name"]); ?></label>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="col-sm-4 col-sm-offset-5">
				<a href="/home1/admin.php/Video/add1?id=<?php echo ($menu["video_id"]); ?>&num=<?php echo ($menu["video_num"]); ?>"><input type="button" class="btn btn-info" <?php if($menu['video_check_state'] == 已通过): ?>style="display:none ;"<?php endif; ?> value="编辑"/></a>
				<input type="button" class="btn btn-group" onclick="javascript:history.back(-1);" value="取消"<?php if($menu['video_check_state'] == 已通过): ?>style="display:none ;"<?php endif; ?>>
			</div>
		</div>
	</div>
</div>
